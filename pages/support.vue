...
export default {
    data() {
        return {
            questions: [
                {
                    question: 'Как получить доступ к курсу в личном кабинете?',
...
.question-item 
{
    ...
    .question
    {
        ...
        padding: 25px;
        padding-right: 50px;
        border-bottom: 1px solid rgba($color: #000000, $alpha: 0.0);
        transition: 0.5s;
        cursor: pointer;
    }
    ...
    .question:after 
    {
        ...
        width: 16px;
        height: 8px;
        background: url(~assets/images/icons/right_blue.png);
        position: absolute;
        right: 25px;
        top: 2px;
        bottom: 0;
